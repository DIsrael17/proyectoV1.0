...
class RecuperandoPueblosController extends Controller
{ 
    public function obtener()
    {
    	// return $municipios=Municipio::all(); 
    	return $municipios=Estado::all();

    			
    	// return Municipio::select('municipios.id_municipio','municipios.nombre_municipio','municipios.estado')->join('estados','estados.id_estado','=','municipios.id_municipio')->get();
    } 
